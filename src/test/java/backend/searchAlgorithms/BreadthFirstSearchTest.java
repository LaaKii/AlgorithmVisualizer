...
public class BreadthFirstSearchTest {
    ...
    public void testDoSearchTargetRight(){
        ...
        Assert.assertTrue(bfs.doSearch(field));
    }
    ...
    @Test
    public void testDoSearchTargetLeft(){
        Index startField = new Index(1,1);
        field.setStartField(startField);


        //Goal left side of start
        buttons[1][0] = goal;
        setAllButtonsUnvisited();
        Index endField = new Index(1,0);
        field.setButtons(buttons);
        field.setEndField(endField);
        Assert.assertTrue(bfs.doSearch(field));
    }
    ...
    @Test
    public void testDoSearchTargetWhenTargetIsNotNear(){
